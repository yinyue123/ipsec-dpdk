...
void snat(struct gateway_ctx *ctx, struct tuple *packet) {
...
int dnat(struct gateway_ctx *ctx, struct tuple *packet) {
	struct nat_table *obj;
...
void cal_nat(struct gateway_ctx *ctx, struct tuple *packet) {
	printf("=================\n");
	print_tuple(packet);
	printf("-----------------\n");
