...
gdb -args \
./build/app/ipsec-secgw --master-lcore 0 -l 0,1 -n 1 --socket-mem=2048,0 --vdev "crypto_openssl" -w 02:00.0 -w 03:00.0 -- -k 0x1 -p 0x3 -P -u 0x01 --config="(0,0,0),(1,0,1)" -f ipsec-test.cfg
